...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre></div>`,24);function $(x,q){const c=p("ExternalLinkIcon"),o=p("RouterLink");return r(),i("div",null,[k,a("p",null,[n("钩子允许你在一些预定义的情况下运行一个代码片段。 它们只在交互式模式下可用（"),a("a",d,[n("REPL"),s(c)]),n("），如果你用脚本（"),h,n("）或命令（"),g,n("）参数运行 Nushell 则不起作用。")]),v,a("p",null,[n("要想使用钩子需要先在 "),s(o,{to:"/zh-CN/book/configuration.html"},{default:e(()=>[n("配置")]),_:1}),n(" 中定义它们：")]),f,a("p",null,[n("钩子的一个特点是它们保留了环境。 在钩子"),b,n("内定义的环境变量将以类似于 "),s(o,{to:"/zh-CN/book/environment.html#%E4%BB%8E%E8%87%AA%E5%AE%9A%E4%B9%89%E5%91%BD%E4%BB%A4%E4%B8%AD%E5%AE%9A%E4%B9%89%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F"},{default:e(()=>[_]),_:1}),n(" 的方式被保留下来。 你可以用下面的例子测试一下：")]),m])}const P=l(u,[["render",$],["__file","hooks.html.vue"]]);export{P as default};
