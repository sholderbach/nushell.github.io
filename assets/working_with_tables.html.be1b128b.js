import{_ as e,z as a,A as t,a6 as n}from"./framework.3d018c9f.js";const s={},d=n(`<h1 id="テーブルを扱う" tabindex="-1"><a class="header-anchor" href="#テーブルを扱う" aria-hidden="true">#</a> テーブルを扱う</h1><p>Nu でデータを表示する一般的な方法はテーブルを使用することです。Nu には、探しているものを見つけやすくしたり、必要なデータを絞り込んだりするのに便利なテーブルを操作するためのコマンドがたくさん用意されています。</p><p>まずはじめに、今回利用するテーブルを確認しましょう。</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls
───┬───────────────┬──────┬─────────┬────────────
