...
</code></pre></div><p>Calling <code>mycmd 1 2</code> now expands to <code>myverylongcommand 1 2</code> and then runs the expanded command.</p><h2 id="improvements" tabindex="-1"><a class="header-anchor" href="#improvements" aria-hidden="true">#</a> Improvements</h2>`,48),k=e("li",null,[a("the "),e("code",null,"which"),a(" command now shows if the name points to an alias or custom command (LhKipp)")],-1),N={href:"https://github.com/nushell/nushell/pull/2829",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/nushell/nushell/pull/2794",target:"_blank",rel:"noopener noreferrer"},T=e("li",null,[a("we support comments now, using "),e("code",null,"#"),a(" (jonathandturner)")],-1),$=e("li",null,[a("better information for debugging in "),e("code",null,"version"),a(" (gillespiecd)")],-1),E=e("li",null,"Thanks to all those who landed general improvements too! (baoyachi, scrabsha, stormasm, max-sixty, ArturKovacs, JosephTLyons)",-1),I=e("h1",{id:"looking-forward",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#looking-forward","aria-hidden":"true"},"#"),a(" Looking forward")],-1),W=e("p",null,"This update opens a lot of doors to what's possible with Nushell. There are a few areas we'd like to explore with it: better autocompletions, describing external commands, and more. We'd also really like to hear your feedback on the release so we can continue to improve the overall experience of using Nu.",-1);function A(L,C){const t=s("ExternalLinkIcon");return i(),l("div",null,[h,u,p,r(" more "),g,e("p",null,[a("Nu 0.25 is available as "),e("a",m,[a("pre-built binaries"),n(t)]),a(" or from "),e("a",f,[a("crates.io"),n(t)]),a(". If you have Rust installed you can install it using "),x,a(".")]),b,w,v,e("p",null,[a("Lots of new features in this release. If you'd like to watch a demonstration, we can also watch a "),e("a",y,[a("video showing off the new features"),n(t)]),a(".")]),_,e("ul",null,[k,e("li",null,[a("you can configure the "),e("a",N,[a("style that primities are shown"),n(t)]),a(" (fdncred)")]),e("li",null,[a("optionally you can "),e("a",q,[a("highlight trailing spaces"),n(t)]),a(" (fdncred)")]),T,$,E]),I,W])}const z=o(c,[["render",A],["__file","2021-01-05-nushell_0_25.html.vue"]]);export{z as default};
