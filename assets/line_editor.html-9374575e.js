...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">..</span>.
  <span class="token punctuation">}</span>
</code></pre></div>`,126);function k(h,m){const s=e("ExternalLinkIcon");return p(),o("div",null,[i,a("p",null,[n("Nushell 的行编辑器 "),a("a",u,[n("Reedline"),c(s)]),n(" 是一个跨平台的行读取器，它被设计为模块化且颇具灵活性的。该引擎的作用是负责控制命令历史，验证，自动补全，提示以及屏幕绘制。")]),r])}const b=t(d,[["render",k],["__file","line_editor.html.vue"]]);export{b as default};
