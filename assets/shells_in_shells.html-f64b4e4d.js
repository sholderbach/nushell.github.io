...
</code></pre></div><p>&quot;Cargo.toml&quot;ファイルにエンターする前の作業ディレクトリにもどっていることがわかります。</p>`,14);function h(g,m){const o=a("RouterLink");return s(),c("div",null,[i,r("p",null,[e('これがどのように機能するかを見るために、次の演習を行いましょう。現在、"Cargo.toml"ファイルの中に開発した'),l(o,{to:"/ja/book/plugins.html"},{default:d(()=>[e("Nu プラグイン")]),_:1}),e('をリストしています。src/plugins ディレクトリの中に"doc.rs"とよばれる新しいプラグインを作成したので、正しくコンパイルされインストールされるか確認したいので"Cargo.toml"にリストされているか知りたいとしましょう。')]),p])}const b=n(u,[["render",h],["__file","shells_in_shells.html.vue"]]);export{b as default};
