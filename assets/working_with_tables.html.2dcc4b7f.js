import{_ as l,z as p,A as c,X as s,C as a,T as e,$ as t,a6 as o,Q as d}from"./framework.3d018c9f.js";const i={},r=o(`<h1 id="处理表格" tabindex="-1"><a class="header-anchor" href="#处理表格" aria-hidden="true">#</a> 处理表格</h1><p>在 Nu 中查看数据的一种常见方式是通过表格。Nu 提供了许多处理表格的命令以方便找到你想要的内容以及将数据缩小到你需要的范围。</p><p>首先，让我们获得一个可用的表：</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls
───┬───────────────┬──────┬─────────┬────────────
...
───┼───────────────
 ...
 6 │ signature.rs
───┴───────────────
`)])],-1),B=s("p",null,"这看起来非常相似！让我们看看能不能把这两个命令的区别说清楚：",-1),K=s("code",null,"select",-1),F=s("code",null,"get",-1),$=s("p",null,"区分这些表格的方法是 —— 列名没有了，也让我们知道这是一个我们可以处理的值的列表。",-1),z=s("code",null,"get",-1),w=s("h2",{id:"修改表格数据",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#修改表格数据","aria-hidden":"true"},"#"),a(" 修改表格数据")],-1),D=s("p",null,"除了从表中选择数据外，还可以更新其中的数据。我们可能想合并表格，添加新的列，或编辑单元格的内容等。在 Nushell 中，本节中的每个命令都会在管道中返回一个新的表而非对原表进行编辑。",-1),N=s("h3",{id:"拼接表格",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#拼接表格","aria-hidden":"true"},"#"),a(" 拼接表格")],-1),q=s("code",null,"append",-1),V=s("div",{class:"language-text","data-ext":"text"},[s("pre",{class:"language-text"},[s("code",null,`> let $first = [[a b]; [1 2]]
> let $second = [[a b]; [3 4]]
> $first | append $second
───┬───┬───
 # │ a │ b
...
──────────────┬──────
 ...
 next_edition │ 2021
──────────────┴──────
`)])],-1),X=s("h3",{id:"更新一列",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#更新一列","aria-hidden":"true"},"#"),a(" 更新一列")],-1),G=s("code",null,"insert",-1),H=s("code",null,"update",-1),I=s("div",{class:"language-text","data-ext":"text"},[s("pre",{class:"language-text"},[s("code",null,`> open rustfmt.toml
─────────┬──────
 edition │ 2018
─────────┴──────
`)])],-1),J=s("p",null,"现在，用我们希望支持的下一个版本更新 edition：",-1),M=s("div",{class:"language-text","data-ext":"text"},[s("pre",{class:"language-text"},[s("code",null,`> open rustfmt.toml | update edition 2021
─────────┬──────
 edition │ 2021
─────────┴──────
