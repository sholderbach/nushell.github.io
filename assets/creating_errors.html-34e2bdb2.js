import{_ as t,M as e,p,q as o,Q as s,t as a,N as c,U as l,a1 as r}from"./framework-344bb0e4.js";const i={},u=s("h1",{id:"创建你自己的错误",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#创建你自己的错误","aria-hidden":"true"},"#"),a(" 创建你自己的错误")],-1),d=r(`<ul><li>错误的标题</li><li>错误信息的标签，其中包括标签的文本和要标注下划线的范围</li></ul><p>你可以使用<code>error make</code>命令来创建你自己的错误信息。例如，假设你有自己的名为<code>my-command</code>的命令，你想给调用者一个错误信息，说明传入的一个参数有问题。</p><p>首先，你可以从参数的来源中获取标注范围：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">let</span> span <span class="token operator">=</span> <span class="token punctuation">(</span>metadata <span class="token variable">$x</span><span class="token punctuation">)</span>.span<span class="token punctuation">;</span>
...
Error:
 ...
 <span class="token number">1</span> │ my-command <span class="token number">100</span>
   ...
   ·             ╰── fish right here
   ╰────
</code></pre></div>`,10);function k(h,m){const n=e("RouterLink");return p(),o("div",null,[u,s("p",null,[a("使用 "),c(n,{to:"/zh-CN/book/metadata.html"},{default:l(()=>[a("元数据")]),_:1}),a(" 信息，你可以创建自己的自定义错误，错误信息由多个部分构成：")]),d])}const b=t(i,[["render",k],["__file","creating_errors.html.vue"]]);export{b as default};
