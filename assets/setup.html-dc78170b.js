...
───┴─────────┴────────┴─────────────────────────────────────┴─────────────────────────────────────
</code></pre></div>`,14);function d(g,m){const s=o("ExternalLinkIcon");return r(),i("div",null,[c,e("p",null,[a("For more detailed instructions, see the environment variables documentation "),e("a",u,[a("here"),p(s)])]),h])}const _=t(l,[["render",d],["__file","setup.html.vue"]]);export{_ as default};
