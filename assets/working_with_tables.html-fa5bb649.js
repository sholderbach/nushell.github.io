import{_ as d,M as l,p as r,q as o,Q as e,t as n,N as a,U as s,a1 as i}from"./framework-344bb0e4.js";const c={},u=i(`<h1 id="mit-tabellen-arbeiten" tabindex="-1"><a class="header-anchor" href="#mit-tabellen-arbeiten" aria-hidden="true">#</a> Mit Tabellen arbeiten</h1><p>Eine der häufigsten Arten mit Daten zu arbeiten geschieht in Nu durch Tabelle. Nu stellt diverse Befehle zur Verfügung, um mit Tabelle auf einfache Art die Daten zu finden und zu filtern, die benötigt werden.</p><p>Um zu starten, wird eine Tabelle benötigt wie diese:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls
───┬───────────────┬──────┬─────────┬────────────
...
───┴───────────────┴──────┴─────────┴────────────
`)])],-1),m=e("p",null,'Es kann nach allen Spalten sortiert werden, die einen Vergleich erlauben. Das Beispiel oben hätte auch nach "name", "accessed" oder "modified" sortiert werden können.',-1),p=e("h2",{id:"die-benotigten-daten-auswahlen",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#die-benotigten-daten-auswahlen","aria-hidden":"true"},"#"),n(" Die benötigten Daten auswählen")],-1),_=e("code",null,"select",-1),f=i(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | select name size
───┬───────────────┬─────────
 # │ name          │ size
───┼───────────────┼─────────
 0 │ files.rs      │  4.6 KB
...
───┴───────────────┴──────┴─────────┴────────────
</code></pre></div><h2 id="daten-aus-der-tabelle-herausziehen" tabindex="-1"><a class="header-anchor" href="#daten-aus-der-tabelle-herausziehen" aria-hidden="true">#</a> Daten aus der Tabelle herausziehen</h2>`,10),b=e("code",null,"get",-1),x=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> ls | get name
───┬───────────────
 0 │ files.rs
 1 │ lib.rs
 2 │ lite_parse.rs
...
...
`)])],-1);function te(ae,se){const t=l("RouterLink");return r(),o("div",null,[u,e("p",null,[n("Um eine Tabelle zu sortieren, wird der "),a(t,{to:"/commands/docs/sort-by.html"},{default:s(()=>[h]),_:1}),n(" Befehl verwendet, dem mitgeteilt wird, nach welcher Spalte sortiert werden soll. Hier wird sortiert nach der Grösse der Dateien:")]),g,m,p,e("p",null,[n("Von einer Tabelle können einzelne Spalten und Zeilen ausgewählt werden. Mit dem "),a(t,{to:"/commands/docs/select.html"},{default:s(()=>[_]),_:1}),n(" Befehl werden hier einige Spalten gewählt.")]),f,e("p",null,[n("Bisher wurde die Tabelle auf die benötigten Inhalte getrimmt. Im nächsten Schritt soll angeschaut werden, wie wir den Inhalt anstelle der Tabelle herausziehen können. Zum Beispiel wenn eine Liste der Namen aller Dateien erstellt werden soll. Dafür steht der "),a(t,{to:"/commands/docs/get.html"},{default:s(()=>[b]),_:1}),n(" Befehl bereit:")]),x,w,e("p",null,[n("Dies sieht fast so aus, wie der "),a(t,{to:"/commands/docs/select.html"},{default:s(()=>[B]),_:1}),n(" Befehl weiter oben, deshalb hier die beiden nebeneinander:")]),z,v,e("ul",null,[e("li",null,[a(t,{to:"/commands/docs/select.html"},{default:s(()=>[y]),_:1}),n(" - generiert eine Tabelle, die nur die gewünschten Spalten enhält")]),e("li",null,[a(t,{to:"/commands/docs/get.html"},{default:s(()=>[k]),_:1}),n(" - gibt den Inhalt der angegebenen Spalte als Liste zurück")])]),e("p",null,[n("Einen Weg, diese zwei auseinander zu halten ist, dass die Spaltennamen fehlen, was bedeutet, es muss sich um eine Liste handeln. Der "),a(t,{to:"/commands/docs/get.html"},{default:s(()=>[K]),_:1}),n(" geht noch einen Schritt weiter und verwendet Pfade um auf tiefer liegende Strukturen zugreifen zu können, wie man sie z.B. in einer .json Datei findet.")]),D,F,S,e("p",null,[n("Mit "),a(t,{to:"/commands/docs/append.html"},{default:s(()=>[T]),_:1}),n(" können Spalten gleichen Namens zusammengeführt werden:")]),$,N,e("p",null,[n("Mit dem "),a(t,{to:"/commands/docs/merge.html"},{default:s(()=>[Z]),_:1}),n(" Befehl werden zwei oder mehr Tabellen zusammengeführt.")]),W,e("p",null,[n("Oder mit dem "),a(t,{to:"/commands/docs/reduce.html"},{default:s(()=>[I]),_:1}),n(" Befehl alle dynamisch gemerged:")]),M,V,e("p",null,[n("Mit dem "),a(t,{to:"/commands/docs/insert.html"},{default:s(()=>[A]),_:1}),n(" Befehl wird eine neue Spalte hinzugefügt. Wie zum Beispiel:")]),E,e("p",null,[n("Änderungen in Nu sind funktionale Änderungen, was bedeutet, dass Werte geändert werden, ohne permanente Änderungen zu bewirken. Es ist deshalb möglich, mehrere Änderungen in der Pipeline vorzunehmen, bevor diese bereit sind um gesichert zu werden. Zum Sichern können wir, wie in diesem Beispiel, den "),a(t,{to:"/commands/docs/save.html"},{default:s(()=>[U]),_:1}),n(" Befehl verwenden:")]),L,q,e("p",null,[n("Ähnlich dem "),a(t,{to:"/commands/docs/insert.html"},{default:s(()=>[P]),_:1}),n(" Befehl, kann mit "),a(t,{to:"/commands/docs/update.html"},{default:s(()=>[j]),_:1}),n(" der Inhalt einer Spalte geändert werden. Auf die selbe Datei angewendet, sieht das so aus:")]),C,H,R,e("p",null,[n("Mit dem "),a(t,{to:"/commands/docs/upsert.html"},{default:s(()=>[G]),_:1}),n(" Befehl wird der Wert enweder eingefügt oder updatet abhängig davon, ob er bereits existriet.")]),O,e("p",null,[n("Mit "),a(t,{to:"/commands/docs/move.html"},{default:s(()=>[Q]),_:1}),n(' werden Spalten in de Tabelle verschoben. Um zum Bespiel die Spalte "name" von "ls" nach der Spalte "size" erschienen zu lassen, schreibt man:')]),J,X,e("p",null,[n("Um Spalten einen neuen Name zu geben, wird der Befehl "),a(t,{to:"/commands/docs/rename.html"},{default:s(()=>[Y]),_:1}),n(" verwendet. Wie zum Beispiel hier nach der Verwendung von "),ee,n(".")]),ne])}const de=d(c,[["render",te],["__file","working_with_tables.html.vue"]]);export{de as default};
