...
license = &quot;MIT&quot;
</code></pre></div><h2 id="url-からの取得" tabindex="-1"><a class="header-anchor" href="#url-からの取得" aria-hidden="true">#</a> URL からの取得</h2><p>ファイルシステムからファイルを読み込むことに加えて、<code>fetch</code>コマンドを利用して URL からリソースを取得できます。 これはインターネットから URL の内容をフェッチして返してくれます。</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; fetch https://www.jonathanturner.org/feed.xml
─────┬───────────────────────────
