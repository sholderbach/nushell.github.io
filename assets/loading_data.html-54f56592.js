import{_ as l,M as c,p as i,q as p,Q as t,t as n,N as s,U as a,a1 as o}from"./framework-344bb0e4.js";const d={},u=t("h1",{id:"加载数据",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#加载数据","aria-hidden":"true"},"#"),n(" 加载数据")],-1),r=t("code",null,"ls",-1),m=t("code",null,"ps",-1),g=t("code",null,"date",-1),_=t("code",null,"sys",-1),h=t("h2",{id:"打开文件",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#打开文件","aria-hidden":"true"},"#"),n(" 打开文件")],-1),x=t("code",null,"open",-1),k=t("div",{class:"language-text","data-ext":"text"},[t("pre",{class:"language-text"},[t("code",null,`> open editors/vscode/package.json
──────────────────┬───────────────────────────────────────────────────────────────────────────────
 name             │ lark
...
──────────────────┴───────────────────────────────────────────────────────────────────────────────
`)])],-1),v=t("code",null,"ls",-1),f=t("code",null,"get",-1),b=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open editors/vscode/package.json | get version
1.0.0
...
───┼─────────┼─────────┼──────────
 ...
 2 │ Antonio │ Vivaldi │ Composer
───┴─────────┴─────────┴──────────
`)])],-1),V=t("code",null,"split",-1),j=o(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open people.txt | lines | split column &quot;|&quot; | str trim | get column1
───┬─────────
 0 │ Octavia
 1 │ Bob
 2 │ Antonio
...
───┴────────────┴───────────┴──────────
</code></pre></div><p>其他可用于字符串的命令有：</p>`,6),A=t("li",null,[t("code",null,"str")],-1),O=t("code",null,"lines",-1),L=t("code",null,"size",-1),P=o(`<p>如果我们已经知道待处理的数据具有 Nu 能够理解的格式，则可以使用一些辅助命令，例如，我们打开一个 Rust 的 Cargo.lock 文件：</p><div class="language-toml" data-ext="toml"><pre class="language-toml"><code>&gt; open Cargo<span class="token punctuation">.</span>lock
...
──────┴───────────────────
`)])],-1);function M(U,z){const e=c("RouterLink");return i(),p("div",null,[u,t("p",null,[n("之前我们使用了"),s(e,{to:"/commands/docs/ls.html"},{default:a(()=>[r]),_:1}),n("、"),s(e,{to:"/commands/docs/ps.html"},{default:a(()=>[m]),_:1}),n("、"),s(e,{to:"/commands/docs/date.html"},{default:a(()=>[g]),_:1}),n("和"),s(e,{to:"/commands/docs/sys.html"},{default:a(()=>[_]),_:1}),n("等命令来加载关于文件、进程、日期时间和系统本身的信息。每条命令都会给我们提供一个信息表，以对其进行探索。我们也可以通过其他方式将数据载入表格以供使用。")]),h,t("p",null,[n("Nu 在处理数据方面最强大的能力之一是"),s(e,{to:"/commands/docs/open.html"},{default:a(()=>[x]),_:1}),n("命令。它是一个多功能命令，可以处理许多不同的数据格式。为了说明这一点让我们试着打开一个 JSON 文件：")]),k,t("p",null,[n("与"),s(e,{to:"/commands/docs/ls.html"},{default:a(()=>[v]),_:1}),n('类似，打开一个 Nu 支持的文件类型，会返回一些不仅仅是文本（或一个字节流）的东西。这里我们打开了一个来自 JavaScript 项目的 "package.json" 文件。Nu 可以识别 JSON 文本并将其解析为一个数据表。')]),t("p",null,[n("如果我们想查看当前项目的版本，我们可以使用"),s(e,{to:"/commands/docs/get.html"},{default:a(()=>[f]),_:1}),n("命令：")]),b,t("p",null,[n("可以看到，我们正在处理这些行，因为我们又回到了一个列表中。下一步是看看是否可以把行分割成更有用的东西。为此，我们将使用"),s(e,{to:"/commands/docs/split.html"},{default:a(()=>[y]),_:1}),n("命令。"),s(e,{to:"/commands/docs/split.html"},{default:a(()=>[q]),_:1}),n("，顾名思义，为我们提供了一种分割字符串的方法。我们将使用"),s(e,{to:"/commands/docs/split.html"},{default:a(()=>[N]),_:1}),n("的"),w,n("子命令，将内容分成多列。我们会告诉它分隔符是什么，剩下的就由它来完成：")]),B,t("p",null,[n("这看起来差不多了，只是还有一些额外的空白字符，让我们 "),s(e,{to:"/commands/docs/str_trim.html"},{default:a(()=>[C]),_:1}),n(" 掉这些空格：")]),R,t("p",null,[n("还不错，"),s(e,{to:"/commands/docs/split.html"},{default:a(()=>[V]),_:1}),n("命令返回给我们可以使用的数据，还预设了默认的列名：")]),j,t("ul",null,[A,t("li",null,[s(e,{to:"/commands/docs/lines.html"},{default:a(()=>[O]),_:1})]),t("li",null,[s(e,{to:"/commands/docs/size.html"},{default:a(()=>[L]),_:1})])]),P,t("p",null,[n("虽然能够打开一个文件并立即使用其数据表很有帮助，但这并不总是我们想要的。为了获得原始文本，"),s(e,{to:"/commands/docs/open.html"},{default:a(()=>[W]),_:1}),n("命令可以接受一个可选的"),S,n("标志：")]),T,t("p",null,[n("除了从文件系统中加载文件，你还可以通过使用"),s(e,{to:"/commands/docs/fetch.html"},{default:a(()=>[E]),_:1}),n("命令来加载 URLs。这将从互联网上获取 URL 的内容并返回：")]),J])}const D=l(d,[["render",M],["__file","loading_data.html.vue"]]);export{D as default};
