...
`)])],-1),_=e("p",null,[t("这个错误信息不仅告诉我们，我们给 "),e("code",null,"from toml"),t(" 的不是一个字符串，还告诉我们这个值最初来自哪里。那么它是如何知道的呢？")],-1),g=e("p",null,"在 Nu 中流经管道的值通常有一些额外信息，或元数据，附加在它们身上。这些通常被称为标签，就像商店里商品上的标签一样。这些标签并不影响数据，但它们给了 Nu 一种方法来改善使用这些数据的体验。",-1),h=e("code",null,"open",-1),f=c(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open Cargo.toml | metadata
────────┬───────────────────────────────────────────
...
───────┴────
</code></pre></div><p>这里的范围 &quot;start&quot; 和 &quot;end&quot; 指的是下划线将标记在行中的位置。如果你数到 5，然后再数到 15，就会看到它与 &quot;Cargo.toml&quot; 文件名一致。这就是我们之前看到的错误是如何知道在何处标注下划线的。</p>`,4);function x(k,C){const a=p("RouterLink");return n(),s("div",null,[u,i,m,_,g,e("p",null,[t("让我们再次运行"),l(a,{to:"/book/commands/open.html"},{default:r(()=>[h]),_:1}),t("命令，但这一次，我们将看一下它所反馈的标签：")]),f])}const v=o(d,[["render",x],["__file","metadata.html.vue"]]);export{v as default};
