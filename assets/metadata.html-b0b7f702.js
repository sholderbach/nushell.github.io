import{_ as e,p as t,q as a,a1 as o}from"./framework-344bb0e4.js";const n={},r=o(`<h1 id="メタデータ" tabindex="-1"><a class="header-anchor" href="#メタデータ" aria-hidden="true">#</a> メタデータ</h1><p>Nu を使用していると裏でなにか特別なことがおきているのではないかと思うことがあるでしょう。例えば、Nu がサポートしているファイル形式を忘れていて、余計に変換しようとしてしまったとしましょう。</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open Cargo.toml | from toml
