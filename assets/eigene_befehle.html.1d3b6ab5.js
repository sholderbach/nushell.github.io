...
───┬─────
 ...
 3 │ --
───┴─────
</code></pre></div><h2 id="persistenz" tabindex="-1"><a class="header-anchor" href="#persistenz" aria-hidden="true">#</a> Persistenz</h2>`,73);function u(h,p){const n=o("RouterLink");return i(),d("div",null,[g,r("p",null,[e("Um Informationen darüber zu erhalten, wie eigene Befehle bei jedem Start von Nushell verfügbar bleiben, sei auf das "),t(n,{to:"/de/book/konfiguration.html"},{default:l(()=>[e("Konfigurationskapitel")]),_:1}),e(" verwiesen.")])])}const m=a(c,[["render",u],["__file","eigene_befehle.html.vue"]]);export{m as default};
